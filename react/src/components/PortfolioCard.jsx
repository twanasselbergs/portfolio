...
const ProjectCard = ({
  ...
  return (
    <div
      className={
        "relative p-6 rounded-[50px] hover:bg-zinc-800/50 duration-500 transition-colors group " +
        classes
      }>
      <figure className="img-box aspect-square rounded-[50px] mx-2 mt-3 mb-5 overflow-hidden">
        <img
          src={imgSrc}
          alt={title}
          loading="lazy"
      ...
      <div className="flex">
        <div className="flex items-center mb-3.5 ml-1.5">
          ...
          {github && (
            <a
              ...
              className="z-10 ml-2 text-zinc-400 hover:text-zinc-100 transition-colors"
      ...
      <p className="h-36 text-sm text-zinc-400 mt-4 px-2 scrollbar-none overflow-y-auto">
        {description}
      </p>
